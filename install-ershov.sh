...
cp ershov.zsh-theme $zsh_custom_directory/themes
printf "${BOLD_CYAN}\n\n[-] ${NC}Installing Theme...\n\n"
...
printf "\n${Green}[✱] ${ORANGE}Ershov ZSH Theme ${Green}Installed successfully!${NC}\n\n"

printf "╔══════════════════════════════════════════╗ \n"
printf "║ Set ${ORANGE}ershov ${NC}as ZSH_THEME in your .zshrc   ║ \n"
printf "╚══════════════════════════════════════════╝ \n\n"
